...
> **"One bug away from reentry." 🚀**

I'm a software developer from Poland focused on **cybersecurity, penetration testing, and low-level programming**.

I learn by **building, breaking, and investigating**.

## 🚀 Projects

* [**Cybersecurity Reports**](#) - security writeups, CTFs & vulnerability research
* [**Tripwire**](#) - Python-based security automation
* [**Embedded CLI**](https://github.com/OfficialCodenaut/embedded-cli) - C++ embedded system simulator
